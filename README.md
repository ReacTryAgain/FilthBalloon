# :balloon: Trash Hunt:
본 오물풍선 웹 서비스 "Trash Hunt"는 북한이 무단으로 살포한 오물풍선의 위치 정보를 제공하여 사용자가 쉽게 상황을 파악할 수 있도록 돕는 종합적인 플랫폼입니다. 오물풍선은 단순한 쓰레기 문제를 넘어, 생화학적, 바이러스적 위험을 동반한 심각한 위협으로 간주되어야 하며, 이에 대한 경각심과 대응책 마련에 도움이 되기 위해 개발되었습니다.
